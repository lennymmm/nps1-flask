...
def analyzeText(text):
    ...
    try:
        ...
        #f deepcat_response.isSuccessful():
        #    categories = deepcat_response.getCategories()
        #    iab2 = (', '.join(deepcat_response.getCategoryLabel(cat) for cat in categories[:1])) if categories else ''
        #else:
...
analyzeText('Esta todo muy bueno y barato')
