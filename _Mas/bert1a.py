...
def AnalizaSent(txt):
    # Tokeniza el texto y obtén las salidas del modelo
...
#print("Predicted rating:",  AnalizaSent("Me encanta este producto. Es fantástico."))
print("Predicted rating:",  AnalizaSent("Esta muy fea y sucia la oficina. Es desagradable") )
